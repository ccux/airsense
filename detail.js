...
graph.innerHTML = '<div class="graph-week-colum-bar-container w-col w-col-10">
	<div class="div-block-2">
	<div class="graph-row w-row">
	<div class="column-9 w-col w-col-10">
	<div class="graph-bar temperature-bar" id="Temp-Graph-Day-12" style="height: 116px;"></div></div>
	<div class="w-col w-col-2">
	<div class="text-block-3">18</div></div></div><div class="graph-row w-row">
	<div class="column-9 w-col w-col-10">';
