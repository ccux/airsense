...
var graphColumHtml = '<div class="graph-row w-row"><div class="column-9 w-col w-col-10"><div class="graph-bar temperature-bar" id="Temp-Graph-Day-9" style="height: 125.66666666666666px;"></div></div><div class="w-col w-col-2"><div class="text-block-3">00</div></div></div>'; 
